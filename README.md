...
An IR proximity sensor watches the doorway. When it detects the door has been opened, the ESP32 reads the sensor state and will trigger a motor to pull the door closed via a cable routed through a mounted hub — mechanically closing it without anyone touching the door.
...
![ESP32 + IR sensor prototype](docs/images/esp32-setup.jpg)
